...
ENV CONAN_SKIP_BROKEN_SYMLINKS_CHECK True
...
RUN cmake -DCMAKE_TOOLCHAIN_FILE=/filament-browser/mingw-w64-x86_64.cmake -B build -S /filament-browser -DCMAKE_BUILD_TYPE=Release -DWIN32=1
